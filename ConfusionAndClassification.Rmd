...
There are some situations where misclassifications like this don’t matter that much, say in marketing or advertising. If someone buys Grande when you predicted brand be, it’s probably not a big deal.
...
classify <- function(df, threshold,offset=1){
  ...
  return(list(observations=observations, confusion=confusion))
}
```
...
ggplot(data=classified$observations, aes(x=actual, y=score)) +
  ...
  # facet_grid(predicted ~ actual, scales="free_x")
```
